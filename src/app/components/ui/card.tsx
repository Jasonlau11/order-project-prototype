...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        "bg-card text-card-foreground flex flex-col gap-4 rounded-md border shadow-[var(--shadow-card)] transition-shadow duration-[var(--duration-fast)] hover:shadow-[var(--shadow-raised)] hover:-translate-y-px",
        className,
      )}
      {...props}
    />
